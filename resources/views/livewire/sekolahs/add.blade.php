        ...
        <div class="px-4 pt-5 pb-4 overflow-y-auto bg-white sm:p-6 sm:pb-4">
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <select wire:model.defer="kurikulum" id="kurikulum" autocomplete="tipe" data-te-select-init>
                            <option>Pilih Kurikulum Sekolah</option>
                            <option value="Negeri">Kurikulum 2013</option>
                            <option value="Swasta">Kurikulum Merdeka</option>
                        </select>
                        <span class="text-red-500">
                            @error('kurikulum')
                                {{ $message }}
