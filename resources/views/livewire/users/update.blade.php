        ...
        <div class="px-4 pt-5 pb-4 overflow-y-auto bg-white sm:p-6 sm:pb-4">
            <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="password" placeholder="Kosongkan jika tidak di rubah" wire:model.defer="password"
                            id="password" autocomplete="job-title"
                            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <span class="text-red-500">
                            @error('password')
                                {{ $message }}
                ...
                <div class="sm:col-span-3">
                    ...
                    <div class="mt-1">
                        <input type="password" placeholder="Kosongkan jika tidak di rubah"
                            wire:model.defer="confir_password" id="confir_password" autocomplete="job-title"
                            class="block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                        <span class="text-red-500">
                    ...
                    @foreach ($roles as $role)
                        <div class="mb-[0.125rem] block min-h-[1.5rem] pl-[1.5rem]">
                            <input
                                ...
                                type="checkbox" wire:model.defer="role_user" value="{{ $role['name'] }}" checked
                                {{ in_array($role['name'], $user->roles->pluck('name')->toArray()) ? 'checked' : 'checked' }}
                                id="{{ $role['id'] }}" />
